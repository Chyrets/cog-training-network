...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        if optimizer_type == "adafactor":
            ...
            args.optimizer_args = ["weight_decay=0.01", "decouple=True",
                                   "use_bias_correction=True"]  # TO TEST from: https://civitai.com/articles/1022/update-sdxl-scriptbdsqlsz-lora-training-advanced-tutorial2prodigy-is-all-you-need
